...
def get_global_players() -> list[tuple[str, str, str, str, str]]:
    ...
    - AMQ Name: Tha AMQ name of the player that the list belongs to.
    - List Name: The name of the list (in Anilist / MyAnimeList).
    - List From: Whether the list is from Anilist or MyAnimeList.
    - List Sections: The sections that must be used when loading the list into your AMQ list.
    ...
    for global_player in global_players if global_player[1] not in {'\xa0', ''}]