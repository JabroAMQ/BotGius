class CQ_SpecialList:
    ...
    def __init__(self, special_list_name: str, community_quiz_name: str, number_of_songs: str, author_name: str) -> None:
        """
    ...
    def __str__(self) -> str:
        ...
        return f'**{self.special_list_name}** // {self.community_quiz_name} // Score {self.number_of_songs} // {self.author_name}'
